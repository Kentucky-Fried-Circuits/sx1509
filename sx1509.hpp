/******************************************************************************
sx1509.hpp
Ported by Brian Alano, Solar Stik, Inc. from
...
#define FALLING 0x02
#define CHANGE 0x03
// My original values. Don't know where I got them.
// #define INPUT 0x0
// #define OUTPUT 0x1
...
public:
	static constexpr const char *LIBTAG = "sx1509";
	...
	//       ANALOG_OUTPUT should also work (TEST)
	// -----------------------------------------------------------------------------
	...
	// -----------------------------------------------------------------------------
	esp_err_t breathe(uint8_t pin, unsigned long tOn, unsigned long tOff, unsigned long rise, unsigned long fall, uint8_t onInt = 255, uint8_t offInt = 0, bool log = LINEAR);
	...
	// -----------------------------------------------------------------------------
	esp_err_t enableInterrupt(uint8_t pin, uint8_t riseFall);
	...
	//      -intSource 16-bit value set by interruptSource(), with a single bit set representing the pin(s) that
